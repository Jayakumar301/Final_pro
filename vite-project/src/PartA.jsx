  ...
  return (
    <div>
      ...
      <form>
        ...
        <input type="checkbox" id="projectCoordinator" name="postHeld" value="Project Coordinator" />
        <label htmlFor="projectCoordinator">Project Coordinator</label>
        <input type="checkbox" id="bosCoordinator" name="postHeld" value="Department BOS Coordinator" />
        <label htmlFor="bosCoordinator">Department BOS Coordinator</label>
        <input type="checkbox" id="curriculumDesign" name="postHeld" value="Coordinator for Curriculum Design" />
        <label htmlFor="curriculumDesign">Coordinator for Curriculum Design</label>
        <br /><br />
